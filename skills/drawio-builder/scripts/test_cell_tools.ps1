...
try {
    ...
    Write-Utf8File $canonical '<mxGraphModel page="1" pageWidth="827" pageHeight="1169"><root><mxCell id="0"/><mxCell id="1" parent="0"/><mxCell id="lane" vertex="1" parent="1" style="swimlane=1;"><mxGeometry x="10" y="20" width="400" height="500" as="geometry"/></mxCell><mxCell id="a" value="Before" vertex="1" parent="lane" style="rounded=1;fillColor=#ffffff;"><mxGeometry x="30" y="40" width="100" height="50" as="geometry"/></mxCell><mxCell id="b" value="Target" vertex="1" parent="lane" style="rounded=1;"><mxGeometry x="250" y="40" width="100" height="50" as="geometry"/></mxCell><mxCell id="e" value="Old" edge="1" parent="lane" source="a" target="b" style="edgeStyle=orthogonalEdgeStyle;exitX=1;entryX=0;"><mxGeometry relative="1" as="geometry"><mxPoint x="0" y="-10" as="offset"/><Array as="points"><mxPoint x="180" y="65"/></Array></mxGeometry></mxCell></root></mxGraphModel>'
