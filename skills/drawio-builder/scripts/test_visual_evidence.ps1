...
$artifactManifest=[ordered]@{schemaVersion=2;page=[ordered]@{id='artifact-page';width=[double]$artifactCanonical.mxGraphModel.pageWidth;height=[double]$artifactCanonical.mxGraphModel.pageHeight};renderer=[ordered]@{name='draw.io';version='test'};delivery=[ordered]@{frameWidthMm=160;frameHeightMm=230;densityPpi=300;minimumEffectiveFontPoints=7.5;cropBorder=16};artifacts=$artifactEntries}
